...
from models.RuleEngine import PredictionQuery, PredictionResponse
from models.RuleEngine import RuleChain, RuleChainResponse, ModelCheckResponse
...
async def check_model(model_id: UUID):
    """
    ...
    """
    try:
        clf = joblib.load('db/model_new_'+str(model_id)+'.joblib')
        clf.test_predict([[0, 0, 0]])
        exists = True
        error_message = ""
...
async def get_prediction_new(model_id: UUID, query: PredictionQuery):
    """
